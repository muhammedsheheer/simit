    ...
    <div className="flex w-full flex-col items-center justify-center gap-3">
      ...
      <Form {...form}>
        ...
        >
                  ...
                  <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
                    <PopoverTrigger asChild>
                      <FormControl>
                        <Button
                          variant={"outline"}
                          className={`h-12 w-full justify-start border-muted bg-transparent text-left font-normal text-muted hover:bg-popover`}
                        >
          ...
          <Button
            className="mt-4 w-fit bg-popover px-6 py-6 font-semibold text-[#fff] hover:bg-[#6b0714]"
            disabled={disable}
          >
            Book A Table
          </Button>
