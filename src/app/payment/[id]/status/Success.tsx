  ...
  if (!data) {
    return (
      <div className="flex h-full w-full flex-col items-center justify-center gap-5 bg-menubackground">
        <p className="text-4xl font-[600] tracking-[2px] text-menuprimary">
          Placing your order...
        </p>
        <Image
      ...
      <div className="flex w-full flex-col items-center justify-center">
        ...
        <div className="flex w-full flex-row items-center justify-between bg-menubackground px-4 py-4 md:flex-col md:items-start md:gap-12 md:px-24 md:py-8">
          ...
          <Link
            href="/menu"
            replace
            className="font-manrope hidden items-center justify-center gap-2 px-[120px] text-lg text-menusecondary md:flex"
          >
            <MoveLeft />
            <p className="font-manrope text-lg text-menusecondary">
              Back To Menu
            </p>
          </Link>
        ...
        <div className="relative h-full w-full bg-menubackground pb-6 md:w-2/4">
          ...
          >
            ...
            <h4 className="font-manrope text-center text-2xl font-[500] leading-[150%] text-menubackground md:text-4xl">
        ...
        <div className="flex w-full flex-col gap-6 bg-menubackground px-4 py-4 md:w-2/4 md:px-0 md:py-8">
          <div className="flex flex-col gap-2 bg-itembackground p-4 md:p-6">
            ...
            <h4 className="font-manrope pb-2 text-sm font-[400] capitalize leading-[80%] tracking-[0.86px] text-menusecondary md:text-lg">
              {restaurant?.name}
            </h4>
            ...
            <div className="flex flex-row gap-3 pt-6">
              <Link
                ...
                target="_blank"
                className="border border-menuprimary bg-menubackground px-4 py-3 text-center font-inter text-sm font-[700] uppercase leading-[22px] text-menuprimary hover:bg-menuprimary hover:text-menusecondary md:text-base"
              >
                Get Directions
              </Link>
              <Link
          ...
          <div className="flex flex-col gap-3 pb-4 md:pb-6">
            <div
              className="flex flex-row justify-between border-b-[0.5px] border-menuprimary pb-2"
              onClick={() => setClose(!close)}
            >
              <h5 className="font-manrope text-lg font-[700] leading-[150%] text-menusecondary md:text-xl">
                View order details
              </h5>
              <ChevronDown
                className={cn(
                    ...
                    if (charge.isPercentage) {
                      return (
                        <div
                          ...
                          key={charge._id}
                        >
                          <p className="font-manrope text-sm font-[400] leading-[150%] text-menusecondary md:text-base">
                            {charge.name}
                          </p>
        ...
        <div className="flex w-full flex-col gap-4 bg-menubackground md:w-2/4">
          {data?.notes && (
            <div className="flex w-full flex-col items-center justify-center gap-2 bg-menubackground px-2 py-4">
              ...
              <p className="font-manrope w-full text-start text-xs font-[400] capitalize text-menusecondary md:text-base">
                {data?.notes}
              </p>
            </div>
          )}
          ...
          {data.orderType !== 2 && (
            <div className="flex flex-col items-center justify-center gap-4 py-6 md:py-8">
              <h3 className="font-manrope pt-4 text-center text-lg font-[800] leading-[150%] text-menuprimary md:pt-6 md:text-2xl">
